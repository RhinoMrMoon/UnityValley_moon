...
public class RotObject : MonoBehaviour
{
    ...
    public TrickyObjectScripts TrickObject;
    ...
    void Start()
    {
        ...
        TrickObject = GameObject.Find("Goal01").GetComponent<TrickyObjectScripts>();
    }

    void Update()
    {
        //if (player.currentCube.parent != GameObject.Find("RotationObject").transform)
        
        if (player.currentCube.parent.parent != GameObject.Find("CenterTower01").transform)
        {
            ...
            if (Input.GetMouseButtonDown(0) && GameManager.instance.Ready)
            {
                ...
                if (Physics.Raycast(mouseRay, out mouseHit))
                {
                    ...
                    {
                        if (mouseHit.transform.gameObject.Equals(transform.GetChild(i).gameObject))
                        {
                            isRotate = true;
