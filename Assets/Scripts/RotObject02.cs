...
public class RotObject02 : MonoBehaviour
{
    ...
    public List<PathCondition02> pathCubes = new List<PathCondition02>();
    ...
    void Update()
    {
        if (player.currentCube.parent.parent != transform.parent)
        {
...
[System.Serializable]
public class PathCondition02
{
    public Vector3 angle;
    public List<SinglePath02> path;
}

[System.Serializable]
public class SinglePath02
{
